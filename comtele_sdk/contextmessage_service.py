...
class ContextMessageService(object):
    ...
    def send(self, sender, context_rule_name, receivers):
        payload = {'sender': sender, 'contextRuleName': context_rule_name, 'receivers': ','.join(receivers)}
    ...
    def schedule(self, sender, context_rule_name, schedule_date, receivers):
        payload = {'sender': sender, 'contextRuleName': context_rule_name, 'scheduleDate': schedule_date, 'receivers': ','.join(receivers)}
    ...
    def get_report(self, start_date, end_date, sender = '', context_rule_name = ''):
        payload = {'startDate': start_date, 'endDate': end_date, 'sender': sender, 'contextRuleName': context_rule_name}
