...
class TextMessageService(object):
    ...
    def send(self, sender, content, receivers):        
        payload = {'sender': sender, 'content': content, 'receivers': ','.join(receivers)}
    ...
    def schedule(self, sender, content, schedule_date, receivers):
        payload = {'sender': sender, 'content': content, 'scheduleDate': schedule_date, 'receivers': ','.join(receivers)}
    ...
    def get_detailed_report(self, start_date, end_date, delivery_status):
        ...
        delivery_status_as_string = self.__delivery_status_to_string(delivery_status)

        payload = {'startDate': start_date, 'endDate': end_date, 'delivered': delivery_status_as_string}        
    ...
    def get_consolidated_report(self, start_date, end_date, group_type):
        ...
        payload = {'startDate': start_date, 'endDate': end_date, 'group': group_type_as_string}        
